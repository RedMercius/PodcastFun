...
public class RadioTitle implements Runnable {
    ...
    private final String[] burnsAllen = {
        ...
        public void getTitleMap(String artist) {

                        for (int i = 0; i < burnsAllen.length; ++i) {
                            MediaMetadataRetriever mediaInfo = new MediaMetadataRetriever();

                            String uri = ("http://www.JohnnieRuffin.com/audio/" + burnsAllen[i]);
                            ...
                            try {
                                ...
                                baMap.put(burnsAllen[i], myTitle);
            ...
            Iterator iterator = baMap.keySet().iterator();

            while (iterator.hasNext()) {
                String key = iterator.next().toString();
                String value = baMap.get(key);

                Log.d(TAG, "Key: " + key);
                Log.d(TAG, "Value: " + value);
            }

                /*baMap.put(burnsAllen[0], "Are Husbands Necessary");
                baMap.put(burnsAllen[1], "Aunt Clark Kangaroo");
                baMap.put(burnsAllen[2], "Beating the 1 c 2");*/
